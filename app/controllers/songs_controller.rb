class SongsController < ApplicationController
  ...
  def index
    @songs = Song.joins(:singer, :type).select("songs.*, singers.name AS singer_name, types.name AS type_name")
  ...
  private
    ...
    def song_params
      params.require(:song).permit(:title, :lyrics, :audio, :type_id, :singer_id)
    end
end
